...
$(function () {    
    (function ($) {
        $.fn.jalendar = function (options) {
            ...
            dayNames['ZN'] = new Array('一', '二', '三', '四', '五', '六', '日');
            ...
            monthNames['ZN'] = new Array('一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'); 
            ...
            function calcMonth() {
                ...
                $this.find('.header h3').html(monthNames[settings.lang][month] + ' ' + year);
                ...
                if ( month == d.getMonth() ) {
                    $this.find('.day.this-month').removeClass('today').eq(date-1).addClass('today').css({'background-color': settings.color});
                } else {
           ...
           $this.find('.events').css('height', ($this.height()-197) );
            ...
            var woodBottomW = $this.find('.wood-bottom').height();
            ...
            function prevAddEvent() {
                ...
                $this.children('.wood-bottom').animate({'height' : woodBottomW}, 200);
                $close.hide();
            }
            ...
            $this.on('click', '.this-month', function () {
                ...
                $this.children('.jalendar-wood, .wood-bottom').animate({height : '+=295px' }, 200, function() {
